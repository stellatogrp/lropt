...
class Budget(UncertaintySet):
    ...
    def __init__(self, rho1=1., rho2=1.,
                 A1=None, A2=None, b1=None, b2=None, c = None, d = None, data=None, loss=None, train_box=True):
        if rho2 <= 0 or rho1 <= 0:
    ...
    def conjugate(self, var, supp_var, shape, k_ind=0):
        ...
        if self.data is not None and self.train_box:
            if shape == 1:
                ...
                return self.rho1 * lmbda1 + self._d@supp_newvar + self.rho2 * lmbda2 - newvar*self.paramb, \
                ...
                return self.rho1 * lmbda1 + supp_newvar@self._d + self.rho2 * lmbda2 - newvar@self.paramb, \
                    constr, (lmbda1, lmbda2)
