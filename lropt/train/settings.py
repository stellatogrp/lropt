...
# Define evaluation input cases
class EVAL_INPUT_CASE(Enum):
    MEAN = 1
    EVALMEAN = 2
...
class TrainerSettings():
    ...
    """
    def __init__(self):
        self.train_size = TRAIN_SIZE_DEFAULT
        self.train_shape = TRAIN_SHAPE_DEFAULT
        self.fixb = FIXB_DEFAULT
        self.num_iter = NUM_ITER_DEFAULT
        self.num_iter_size = NUM_ITER_SIZE_DEFAULT
        self.lr = LR_DEFAULT
        self.lr_size = LR_SIZE_DEFAULT
        self.scheduler = SCHEDULER_STEPLR_DEFAULT
        self.momentum = MOMENTUM_DEFAULT
        self.optimizer = OPT_DEFAULT
        self.init_rho = INIT_RHO_DEFAULT
        self.init_A = INIT_A_DEFAULT
        self.init_b = INIT_B_DEFAULT
        self.save_history = SAVE_HISTORY_DEFAULT
        self.seed = SEED_DEFAULT
        self.init_lam = INIT_LAM_DEFAULT
        self.init_mu = INIT_MU_DEFAULT
        self.mu_multiplier = MU_MULTIPLIER_DEFAULT
        self.init_alpha = INIT_ALPHA_DEFAULT
        self.eta = ETA_LAGRANGIAN_DEFAULT
        self.kappa = KAPPA_DEFAULT
        self.random_init = RANDOM_INIT_DEFAULT
        self.num_random_init = NUM_RANDOM_INIT_DEFAULT
        self.test_frequency = TEST_FREQUENCY_DEFAULT
        self.test_percentage = TEST_PERCENTAGE_DEFAULT
        self.batch_percentage = BATCH_PERCENTAGE_DEFAULT
        ...
        self.aug_lag_update_interval = UPDATE_INTERVAL
        self.lambda_update_threshold = LAMBDA_UPDATE_THRESHOLD
        self.lambda_update_max = LAMBDA_UPDATE_MAX
        self.max_batch_size = MAX_BATCH_SIZE
        self.contextual = CONTEXTUAL_DEFAULT
        self.linear = CONTEXTUAL_LINEAR_DEFAULT
        self.init_weight = CONTEXTUAL_WEIGHT_DEFAULT
        self.init_bias = CONTEXTUAL_BIAS_DEFAULT
        self.x_endind = X_ENDIND_DEFAULT
        self.max_iter_line_search = DEFAULT_MAX_ITER_LINE_SEARCH
        self.policy = POLICY_DEFAULT
        self.time_horizon = TIME_HORIZON_DEFAULT
        self.batch_size = BATCH_SIZE_DEFAULT
        self.test_batch_size = TEST_BATCH_SIZE_DEFAULT
        self.simulator = SIMULATOR_DEFAULT
        self.kwargs_simulator = KWARGS_SIM_DEFAULT
        self.multistage = MULTISTAGE_DEFAULT
